...
public class newAnalysisGraph extends BaseActivity {
                        ...
                        for(SalesReturnsmaltadashboardModel salesDataResponce : salesData) {
                            ...
                            if( !"All Routes".equals(route_name)) {
                                ...
                                try {
                                    ...
                                    //here for actual sales parameter is net amount given from backend which is (totalsales - resuseable)
                                    String salesTotalNet = salesDataResponce.getNetamount();
                                    String returnsTotalNet = salesDataResponce.getReturn_amt();
        ...
        try {
            ...
            for (salesReturnsDateWise salesReturn : salesReturnsForTabList) {
                ...
                if(!"All Dates".equals(date)) {
                    ...
                    double returns = isValidDouble(salesReturn.getReturn_amt()) ? Double.parseDouble(salesReturn.getReturn_amt()) : 0.0;
...
//    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(newAnalysisGraph.this, dashboard_analysis.class);
