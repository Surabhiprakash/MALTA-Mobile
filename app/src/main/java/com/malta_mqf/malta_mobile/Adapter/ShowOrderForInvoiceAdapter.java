...
public class ShowOrderForInvoiceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ShowOrderForInvoiceAdapter.HViewHolder holder;

        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_credit_note, null);
            holder = new ShowOrderForInvoiceAdapter.HViewHolder();
            convertView.setTag(holder);
        } else {
            holder = (ShowOrderForInvoiceAdapter.HViewHolder) convertView.getTag();
        }
