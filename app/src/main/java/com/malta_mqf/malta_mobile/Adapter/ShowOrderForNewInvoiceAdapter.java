...
public class ShowOrderForNewInvoiceAdapter extends BaseAdapter {
    ...
    @Override
    public NewOrderInvoiceBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final ShowOrderForNewInvoiceAdapter.HViewHolder holder;

        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_credit_note, null);
            holder = new ShowOrderForNewInvoiceAdapter.HViewHolder();
            convertView.setTag(holder);
        } else {
            holder = (ShowOrderForNewInvoiceAdapter.HViewHolder) convertView.getTag();
        }
