...
public class ApiLinks {
  ...
  public static final String urlBase = "https://maltaqf.com/api/GFC/rest/";//MALTA url
    ...
    public static final String get_outlet_associated_skus_for_agency = urlBase + "outlet_skus/get_outlet_associated_skus_for_agency_with_barcode";
    public static final String get_outlet_associated_skus_agency = urlBase + "outlet_skus/get_outlet_associated_sku_agency";
   ...
   public static final String getInvoiceDetailsByInvoiceNo = urlBase + "order/previousInvoiceDetailsForMalta";
