...
import static com.malta_mqf.malta_mobile.SewooPrinter.Sample_Print.totalGrossAmount;
   ...
   Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  button_finish.setBackgroundColor(getResources().getColor(R.color.appColorpurple));
        ...
        customername=getIntent().getStringExtra("customercode");
        ...
        String newSaleBeanListJson = getIntent().getStringExtra("orderToInvoice");
        if (newSaleBeanListJson != null) {
            Type type = new TypeToken<ArrayList<ShowOrderForInvoiceBean>>() {}.getType();
            newSaleBeanListsss = new Gson().fromJson(newSaleBeanListJson, type);
        } else {
            newSaleBeanListsss = new ArrayList<>();
        }
            ...
            asyncDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Stop",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            searchflags = true;
                            if (ActivityCompat.checkSelfPermission(Bluetooth_Activity.this, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
                                // TODO: Consider calling
                                //    ActivityCompat#requestPermissions
                                // here to request the missing permissions, and then overriding
                                //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (activity != null && !activity.isFinishing() && !activity.isDestroyed()) {
                ...
                if (result != null && result == 0) {
                    ...
                    Sample_Print sp = new Sample_Print();
                    try {
                        sp.Print_Sample_4();
                    } catch (IOException e) {
                        throw new RuntimeException(e);
...
// Store in SharedPreferences
        ...
        protected void onPostExecute(Integer result)
        {
            ...
            if(result.intValue() == 0)	// Connection success.
            {
                ...
                Sample_Print sp1 = new Sample_Print();
                try {
